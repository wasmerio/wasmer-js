(module
  ...
  ;; Lowerings
  (type (;15;) (func (param i32 i32 i32 i32) (result i32))) ;; fd_seek (8)
  (type (;16;) (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32))) ;; path_open (5)
  ...
  (import "wasi_unstable" "path_open" (func $__wasi_path_open (type 16)))
  ...
  (func $frexp (type 14) (param f64 i32) (result f64)
    ...
    local.get 0)
  (func $__wasi_fd_seek_wrapped (type 8) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.wrap_i64
    local.get 2
    local.get 3
    call $__wasi_fd_seek)
  (func $__wasi_path_open_wrapped (type 5) (param i32 i32 i32 i32 i32 i64 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
