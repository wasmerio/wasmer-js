...
export function memfs_rename(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function jsvirtualfile_write(a: number, b: number, c: number, d: number): void;
