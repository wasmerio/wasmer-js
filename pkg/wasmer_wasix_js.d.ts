...
export interface InitOutput {
  ...
  readonly closure247_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure424_externref_shim: (a: number, b: number, c: number) => number;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __externref_table_dealloc: (a: number) => void;
  readonly __externref_table_alloc: () => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly closure214_externref_shim: (a: number, b: number, c: number, d: number) => void;
