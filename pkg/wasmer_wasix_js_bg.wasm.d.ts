...
export function closure247_externref_shim(a: number, b: number, c: number): void;
export function closure424_externref_shim(a: number, b: number, c: number): number;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __externref_table_dealloc(a: number): void;
export function __externref_table_alloc(): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function closure214_externref_shim(a: number, b: number, c: number, d: number): void;
